<template>
    <footer class="text-white bg-green-600">
      <div class="max-w-6xl px-4 py-10 mx-auto">
        <div class="flex flex-wrap justify-between">
          <div class="w-full mb-6 md:w-1/4 md:mb-0">
            <h2 class="mb-4 text-2xl">PlantID</h2>
            <p class="text-green-200">Discover and learn about plants with our AI-powered plant identification tool.</p>
          </div>
          <div class="w-full mb-6 md:w-1/4 md:mb-0">
            ...
            <ul>
              ...
              <li><a href="#" class="text-green-200 hover:text-white">Services</a></li>
              <li><a href="#" class="text-green-200 hover:text-white">Contact</a></li>
            </ul>
          </div>
          <div class="w-full mb-6 md:w-1/4 md:mb-0">
            <h3 class="mb-4 text-xl">Contact Us</h3>
            <p class="text-green-200">Email: info@plantid.com</p>
        ...
        <div class="pt-8 mt-8 text-center border-t border-green-500">
